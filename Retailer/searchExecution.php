...
<body>
    ...
    if (isset($_POST['searchQuery']) || isset($_SESSION['searchQuery'])) :
        ...
        $retailername =  $_SESSION['retailername'];
        $query = "select * from product where productname like'%$searchQuery%' and retailername = '$retailername' ";
            ...
            ?>
                <a href="#"?pid=<?= $product['pid'] ?>">
                    <div class="card">
                        ...
                        <form class='cart' action="deleteproduct.php" method="post">
                            <input type="hidden" name="pid" value="<?= $product['pid'] ?>">
                           
                            <button class="addToCart" type="submit" id='submit'>Delete</button>
                        </form>
                        <?= "<script>" ?>
