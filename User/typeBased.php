...
<body>
    ...
    if (isset($_POST['typeofproduct'])) {
        ...
        $_SESSION['typeofproduct'] = $typeofproduct;
    }
    if (isset($_POST['typeofproduct']) || isset($_SESSION['typeofproduct'])) :
        $typeofproduct = $_SESSION['typeofproduct'];
        $query = "select * from product where typeofproduct='$typeofproduct' ";
        $result = mysqli_query($db, $query);
        $fetch = mysqli_fetch_all($result, MYSQLI_ASSOC);
        // print_r($fetch);
    ?>
        <a style="color: blue;padding:10px" href="user_home_page.php">&lt; Back to home</a>
        <div class="cards">
            <?php
