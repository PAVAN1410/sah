...
<body>
    ...
    <div class="add">
        <div class="Admin card">
            <h2 style="display: inline-block;">Delete delivery Boy</h2>
            <form action="dbdeleteDeliveryBoy.php" class="form" method="POST">
                <input class="element" type="text" name="deliveryboyname" placeholder="User Name" required><br>
