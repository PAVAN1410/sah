...
<body>
    ...
    <div class="login">
        <div class="user card">
            ...
            <div class="login">
                <form class="form_result" action="User/user_registration_page.php" method="POST" onsubmit="return matchpassword()">
            ...
            <a href="RetailerRegisteration.php" class="registerRetailer">Register as Retailer</a>
        </div>
    </div>
    <script>
